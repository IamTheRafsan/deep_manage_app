class WeightLessItemModel {
  ...
  factory WeightLessItemModel.fromJson(Map<String, dynamic> json) {
    ...
    return WeightLessItemModel(
      id: json['id']?.toString() ?? '',
      weightLessId: json['weightLess'] != null ?
      json['weightLess']['id']?.toString() ?? '' : '',
